...
export const METAL_PARTS = {
  legs: [
    ...
    { id: 'round-pipe-50', name: '원형파이프 다리 Ø50', size: 'Ø50mm', material: 'steel', finish: 'chrome', roughness: 0.15, metalness: 0.95 },
    { id: 'flat-bar-leg', name: '플랫바 다리 (40×3T)', size: '40×3mm', material: 'steel', finish: 'powder-coated', roughness: 0.6, metalness: 0.4 },
    { id: 'flat-bar-leg-50', name: '플랫바 다리 (50×5T)', size: '50×5mm', material: 'steel', finish: 'powder-coated', roughness: 0.6, metalness: 0.4 },
    ...
    { id: 'hairpin-leg', name: '헤어핀 다리', size: 'Ø10mm Rod', material: 'steel', finish: 'powder-coated', roughness: 0.5, metalness: 0.5 },
    { id: 'sled-base', name: '슬레드 베이스', size: 'Ø16mm', material: 'steel', finish: 'chrome', roughness: 0.2, metalness: 0.9 },
    { id: 'trestle-leg', name: '트레슬 다리 (A자형)', size: '40×20mm', material: 'steel', finish: 'powder-coated', roughness: 0.65, metalness: 0.3 },
    { id: 'cantilever-base', name: '캔틸레버 베이스', size: '50×25mm', material: 'steel', finish: 'chrome', roughness: 0.2, metalness: 0.85 },
    { id: 'panel-leg', name: '패널 다리 (측판형)', size: '18T PB/MDF', material: 'wood', finish: 'melamine', roughness: 0.4, metalness: 0 },
  ],
  frames: [
    ...
    { id: 'steel-frame-50', name: '스틸 프레임 50×25', size: '50×25mm', material: 'steel', description: '대형 테이블 프레임', roughness: 0.65, metalness: 0.3 },
    ...
    { id: 'angle-bar-40', name: '앵글바 (L형강) 40', size: '40×40×3mm', material: 'steel', description: '대형 보강용 앵글바', roughness: 0.7, metalness: 0.3 },
    { id: 'aluminum-extrusion', name: '알루미늄 압출재', size: '40×40mm', material: 'aluminum', description: '알루미늄 프로파일', roughness: 0.3, metalness: 0.8 },
    { id: 'h-beam-mini', name: '미니 H빔', size: '50×25mm', material: 'steel', description: '구조용 미니 H빔', roughness: 0.7, metalness: 0.3 },
  ],
  hardware: [
    { id: 'caster-50', name: '캐스터 Ø50 (나일론)', size: 'Ø50mm', type: 'caster' },
    { id: 'caster-65', name: '캐스터 Ø65 (PU)', size: 'Ø65mm', type: 'caster' },
    { id: 'caster-75', name: '캐스터 Ø75 (고하중)', size: 'Ø75mm', type: 'caster' },
    { id: 'caster-brake', name: '브레이크 캐스터 Ø50', size: 'Ø50mm', type: 'caster' },
    { id: 'adj-foot-m8', name: '수평 조절발 M8', size: 'M8', type: 'adjustable-foot' },
    { id: 'adj-foot-m10', name: '수평 조절발 M10', size: 'M10', type: 'adjustable-foot' },
    { id: 'adj-foot-m12', name: '수평 조절발 M12', size: 'M12', type: 'adjustable-foot' },
    { id: 'glider-nail', name: '못 글라이더', size: 'Ø20mm', type: 'glider' },
    { id: 'glider-felt', name: '펠트 글라이더', size: 'Ø25mm', type: 'glider' },
    { id: 'handle-bow-96', name: '활형 손잡이 96mm', size: '96mm', type: 'handle' },
    { id: 'handle-bow-128', name: '활형 손잡이 128mm', size: '128mm', type: 'handle' },
    { id: 'handle-bow-160', name: '활형 손잡이 160mm', size: '160mm', type: 'handle' },
    { id: 'handle-bar-192', name: '바 손잡이 192mm', size: '192mm', type: 'handle' },
    { id: 'handle-bar-256', name: '바 손잡이 256mm', size: '256mm', type: 'handle' },
    { id: 'handle-recessed', name: '매입 손잡이', size: '120×40mm', type: 'handle' },
    { id: 'handle-edge', name: '엣지 손잡이 (무손잡이)', size: '45도 경사', type: 'handle' },
    { id: 'handle-knob', name: '노브 손잡이', size: 'Ø30mm', type: 'handle' },
    { id: 'hinge-concealed', name: '컨실드 경첩', size: '35mm', type: 'hinge' },
    { id: 'hinge-concealed-soft', name: '컨실드 경첩 (소프트클로즈)', size: '35mm', type: 'hinge' },
    { id: 'hinge-piano', name: '피아노 경첩', size: '전장', type: 'hinge' },
    { id: 'hinge-butt', name: '평경첩 (나비경첩)', size: '75mm', type: 'hinge' },
    { id: 'hinge-flap', name: '플랩 경첩 (상개폐)', size: '110도', type: 'hinge' },
    { id: 'slide-full', name: '풀익스텐션 서랍레일', size: '400mm', type: 'slide' },
    { id: 'slide-full-500', name: '풀익스텐션 서랍레일', size: '500mm', type: 'slide' },
    { id: 'slide-ball', name: '볼베어링 레일', size: '400mm', type: 'slide' },
    { id: 'slide-soft', name: '소프트클로즈 레일', size: '450mm', type: 'slide' },
    { id: 'slide-undermount', name: '언더마운트 레일', size: '500mm', type: 'slide' },
    { id: 'lock-cam', name: '캠 잠금장치', size: '16mm', type: 'lock' },
    { id: 'lock-cylinder', name: '실린더 잠금장치', size: '20mm', type: 'lock' },
    { id: 'lock-push', name: '푸시락 잠금장치', size: '자동', type: 'lock' },
    { id: 'lock-digital', name: '디지털 잠금장치', size: '전자식', type: 'lock' },
    ...
    { id: 'cable-tray-900', name: '케이블 트레이', size: '900mm', type: 'cable-management' },
    { id: 'cable-spine', name: '케이블 스파인 (뱀형)', size: '700mm', type: 'cable-management' },
    { id: 'modesty-panel', name: '모데스티 패널', size: '600×300mm', type: 'panel' },
    { id: 'modesty-panel-full', name: '모데스티 패널 (풀사이즈)', size: '1200×400mm', type: 'panel' },
    { id: 'shelf-bracket', name: '선반 브래킷', size: '200mm', type: 'bracket' },
    { id: 'shelf-bracket-300', name: '선반 브래킷', size: '300mm', type: 'bracket' },
    { id: 'shelf-pin', name: '선반 핀 (타봉)', size: 'Ø5mm', type: 'bracket' },
    { id: 'connector-minifix', name: '미니픽스 커넥터', size: 'Ø15mm', type: 'connector' },
    { id: 'connector-rafix', name: '라픽스 커넥터', size: 'Ø20mm', type: 'connector' },
    { id: 'connector-cam', name: '캠 커넥터', size: 'Ø35mm', type: 'connector' },
    { id: 'dowel-wood', name: '목재 다웰핀', size: 'Ø8×30mm', type: 'connector' },
    { id: 'damper-soft', name: '소프트 댐퍼', size: '자동', type: 'damper' },
    { id: 'stay-arm', name: '스테이 암 (도어 고정)', size: '250mm', type: 'stay' },
    { id: 'gas-strut', name: '가스 스프링 (상개폐)', size: '100N', type: 'stay' },
  ],
  chair_parts: [
    ...
    { id: 'star-base-5-chrome', name: '5발 스타베이스 (크롬)', size: 'Ø600mm', material: 'steel', finish: 'chrome' },
    { id: 'four-leg-base', name: '4발 의자 프레임', size: 'Ø16mm', material: 'steel', finish: 'powder-coated' },
    { id: 'sled-chair-base', name: '슬레드 의자 베이스', size: 'Ø12mm', material: 'steel', finish: 'chrome' },
    { id: 'gas-cylinder', name: '가스 실린더', size: 'Class 4', type: 'mechanism' },
    { id: 'gas-cylinder-heavy', name: '가스 실린더 (고하중)', size: 'Class 4+', type: 'mechanism' },
    { id: 'tilt-mechanism', name: '틸팅 메커니즘', size: '싱크로', type: 'mechanism' },
    { id: 'armrest-fixed', name: '고정 팔걸이 (PP)', size: '250mm', type: 'armrest' },
    { id: 'armrest-adj', name: '조절 팔걸이 (PU패드)', size: '280mm', type: 'armrest' },
    { id: 'armrest-3d', name: '3D 조절 팔걸이', size: '300mm', type: 'armrest' },
    { id: 'armrest-flip', name: '접이식 팔걸이', size: '250mm', type: 'armrest' },
    { id: 'lumbar-support', name: '럼버서포트', size: '400mm', type: 'support' },
    { id: 'headrest', name: '헤드레스트', size: '200×150mm', type: 'headrest' },
    { id: 'headrest-adj', name: '높이조절 헤드레스트', size: '200×150mm', type: 'headrest' },
    { id: 'seat-slider', name: '좌판 슬라이더', size: '50mm', type: 'mechanism' },
    { id: 'footrest-ring', name: '발받침 링', size: 'Ø400mm', type: 'support' },
  ],
} as const;
